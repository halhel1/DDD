...
func set_entity(entity_scene, entity_radius):
    entityScene = entity_scene
    entityRadius = entity_radius

func spawn_entities(num_entities, colors=[], sprite=""):
